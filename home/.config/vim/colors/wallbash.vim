...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['974C4E', '6965A3', 'C27A7C', '7A92C2',
                                \ '6592A3', '9AB3E6', 'E69A9C', 'FFFFFF',
                                \ '2D4E5B', '7F7AC2', 'E69A9C', 'AAC1F0',
                                \ '7AAEC2', 'AAC1F0', 'F0AAAC', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', '9F9AE6', 'F0AAAC', 'AAC1F0',
                                \ '9AD0E6', 'CCDDFF', 'FFCCCD', '272E3C',
                                \ 'FFFFFF', 'AFAAF0', 'FFCCCD', 'CCDDFF',
                                \ 'AADCF0', 'CCDDFF', 'FFCCCD', '974C4E']
  endif
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#272E3C guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#272E3C gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#2D4E5B gui=NONE cterm=NONE
  hi VertSplit guifg=#A36567 guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#A36567 guibg=NONE gui=NONE cterm=NONE
  ...
  hi NeoTreeFloatBorder guifg=#A36567 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeWinSeparator guifg=#2D4E5B guibg=NONE gui=NONE cterm=NONE

  " NeoTree with transparent background
  hi NeoTreeNormal guibg=NONE guifg=#FFFFFF gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#FFFFFF gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#FFCCCD guibg=NONE gui=bold cterm=bold

  " TabLine highlighting with complementary accents
  hi TabLine guifg=#FFFFFF guibg=#272E3C gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#974C4E guibg=#FFCCCD gui=bold cterm=bold
  hi TabLineSeparator guifg=#A36567 guibg=#272E3C gui=NONE cterm=NONE

  " Interactive elements with dynamic contrast
  hi Search guifg=#2D4E5B guibg=#F0AAAC gui=NONE cterm=NONE
  hi Visual guifg=#2D4E5B guibg=#E69A9C gui=NONE cterm=NONE
  hi MatchParen guifg=#2D4E5B guibg=#FFCCCD gui=bold cterm=bold

  " Menu item hover highlight
  hi CmpItemAbbrMatch guifg=#FFCCCD guibg=NONE gui=bold cterm=bold
  hi CmpItemAbbrMatchFuzzy guifg=#F0AAAC guibg=NONE gui=bold cterm=bold
  ...
  hi WhichKey guifg=#FFCCCD guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyGroup guifg=#E69A9C guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyDesc guifg=#F0AAAC guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyFloat guibg=#2D4E5B guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#272E3C gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  hi CursorLineNr guifg=#FFCCCD guibg=NONE gui=bold cterm=bold

  hi QuickFixLine guifg=#2D4E5B guibg=#E69A9C gui=NONE cterm=NONE
  hi IncSearch guifg=#2D4E5B guibg=#FFCCCD gui=NONE cterm=NONE
  hi NormalNC guibg=#2D4E5B guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#F0AAAC guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#2D4E5B guibg=#FFCCCD gui=bold cterm=bold

  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#FFCCCD guibg=#2D4E5B gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#272E3C gui=italic cterm=italic
  ...
  hi NeoTreeFileIcon guifg=#F0AAAC guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeDirectoryName guifg=#F0AAAC guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeDirectoryIcon guifg=#F0AAAC guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitModified guifg=#E69A9C guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitAdded guifg=#C27A7C guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitDeleted guifg=#6965A3 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7A92C2 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeIndentMarker guifg=#8F5759 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeSymbolicLinkTarget guifg=#E69A9C guibg=NONE gui=NONE cterm=NONE

  " File explorer cursor highlights with strong contrast
  " hi NeoTreeCursorLine guibg=#E69A9C guifg=#974C4E gui=bold cterm=bold
  ...
  hi WinBar guifg=#FFFFFF guibg=#272E3C gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#2D4E5B gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#FFCCCD guifg=#974C4E gui=bold cterm=bold
  hi BufferTabpageFill guibg=#974C4E guifg=#FFFFFF gui=NONE cterm=NONE
  hi BufferCurrent guifg=#FFFFFF guibg=#FFCCCD gui=bold cterm=bold
  hi BufferCurrentMod guifg=#FFFFFF guibg=#E69A9C gui=bold cterm=bold
  hi BufferCurrentSign guifg=#FFCCCD guibg=#2D4E5B gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#272E3C gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#272E3C gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#E69A9C guibg=#2D4E5B gui=NONE cterm=NONE
  hi BufferInactive guifg=#FFFFFF guibg=#2D4E5B gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#A36567 guibg=#2D4E5B gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#A36567 guibg=#2D4E5B gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#974C4E gui=NONE cterm=NONE
  hi Pmenu guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#4B5C7D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#974C4E guibg=#FFFFFF gui=NONE cterm=NONE
  hi VertSplit guifg=#4B5C7D guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#4B5C7D guibg=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#2D4E5B guibg=NONE gui=NONE cterm=NONE

  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#974C4E gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#974C4E gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#974C4E gui=NONE cterm=NONE
  ...
  " TabLine highlighting with complementary accents
  hi TabLine guifg=#974C4E guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#FFFFFF guibg=#294652 gui=bold cterm=bold
  hi TabLineSeparator guifg=#4B5C7D guibg=#FFFFFF gui=NONE cterm=NONE

  " Interactive elements with complementary contrast
  hi Search guifg=#FFFFFF guibg=#3A5D6B gui=NONE cterm=NONE
  hi Visual guifg=#FFFFFF guibg=#4B5C7D gui=NONE cterm=NONE
  ...
  hi CmpItemMenu guifg=#2D4E5B guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#974C4E guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#272E3C guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#294652 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#272E3C guibg=NONE gui=NONE cterm=NONE
  ...
  hi Cursor guibg=#974C4E guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi TermCursor guibg=#974C4E guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#974C4E gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  ...
  hi NormalNC guibg=#FFFFFF guifg=#2D4E5B gui=NONE cterm=NONE
  ...
  hi FoldColumn guifg=#2D4E5B guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#974C4E guibg=#FFFFFF gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#974C4E gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#974C4E gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#294652 guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#974C4E guibg=NONE gui=NONE cterm=NONE
  ...
  hi NeoTreeGitAdded guifg=#576A8F guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitDeleted guifg=#6965A3 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7A92C2 guibg=NONE gui=NONE cterm=NONE
  ...
  hi WinBar guifg=#974C4E guibg=#FFFFFF gui=bold cterm=bold
  hi WinBarNC guifg=#2D4E5B guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#294652 guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#272E3C gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#974C4E guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#2D4E5B guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#4B6F7D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#272E3C guibg=#FFFFFF gui=NONE cterm=NONE
...
hi FloatBorder guifg=#4B5C7D guibg=NONE gui=NONE cterm=NONE
hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#FFFFFF guibg=#C27A7C gui=NONE cterm=NONE
hi DiffChange guifg=#FFFFFF guibg=#657AA3 gui=NONE cterm=NONE
hi DiffDelete guifg=#FFFFFF guibg=#6965A3 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE

" Fix selection highlighting with proper color derivatives
hi TelescopeSelection guibg=#CCDDFF guifg=#974C4E gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#CCDDFF gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#9AB3E6 guifg=#974C4E gui=bold cterm=bold
hi TelescopeMatching guifg=#7F7AC2 guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#CCDDFF guifg=#974C4E gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#CFCCFF guifg=#974C4E gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#CFCCFF guifg=#974C4E gui=bold
hi WildMenu guibg=#CFCCFF guifg=#974C4E gui=bold
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#CCDDFF guifg=#974C4E gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#CCDDFF guifg=#974C4E gui=bold cterm=bold |
    \ else |
